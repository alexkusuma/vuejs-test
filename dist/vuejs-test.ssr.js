...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-1b902ffa_0", {
    source: ".vuejs-test[data-v-1b902ffa]{display:block;width:400px;margin:25px auto;border:1px solid #ccc;background:#eaeaea;text-align:center;padding:25px}.vuejs-test p[data-v-1b902ffa]{margin:0 0 1em}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-1b902ffa";
/* module identifier */

var __vue_module_identifier__ = "data-v-1b902ffa";
/* functional template */
...
var install = function installVuejsTest(Vue) {
  if (install.installed) return;
  install.installed = true;
  Vue.component('VuejsTest', __vue_component__);
